...
package migracion_cajamar.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024
							&& commonByteArray_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MIGRACION_CAJAMAR_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Users/diego.alvarez.fernan/Documents/GitHub/cajamar_migration/Hkeys/stage/carga_ficheros/MIGRACION_CAJAMAR/temp/preview/FACTIVOS.csv"))
				...
				String[] headColutFileOutputDelimited = new String[94];
				...
				CsvWritertFileOutputDelimited = new com.talend.csv.CSVWriter(
						new java.io.BufferedWriter(new java.io.OutputStreamWriter(
								new java.io.FileOutputStream(fileName_tFileOutputDelimited, false), "ISO-8859-1")));
				...
				try {
					...
					Object filename_tFileInputDelimited = "G:/.shortcut-targets-by-id/13dwvsJwtH7qTkK0HGZd6OyiOZv0nXuVy/01. Proyecto WV/07. Migración/08. PRX/FACTIVOS.csv";
					...
					try {
						fid_tFileInputDelimited = new org.talend.fileprocess.FileInputDelimited(
								"G:/.shortcut-targets-by-id/13dwvsJwtH7qTkK0HGZd6OyiOZv0nXuVy/01. Proyecto WV/07. Migración/08. PRX/FACTIVOS.csv",
					...
					while (fid_tFileInputDelimited != null && fid_tFileInputDelimited.nextRecord()) {
						...
						try {
							...
							Row.row31 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 32;

							Row.row32 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 33;

							Row.row33 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 34;

							Row.row34 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 35;

							Row.row35 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 36;

							Row.row36 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 37;

							Row.row37 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 38;

							Row.row38 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 39;

							Row.row39 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 40;

							Row.row40 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 41;

							Row.row41 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 42;

							Row.row42 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 43;

							Row.row43 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 44;

							Row.row44 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 45;

							Row.row45 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 46;

							Row.row46 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 47;

							Row.row47 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 48;

							Row.row48 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 49;

							Row.row49 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 50;

							Row.row50 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 51;

							Row.row51 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 52;

							Row.row52 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 53;

							Row.row53 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 54;

							Row.row54 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 55;

							Row.row55 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 56;

							Row.row56 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 57;

							Row.row57 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 58;

							Row.row58 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 59;

							Row.row59 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 60;

							Row.row60 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 61;

							Row.row61 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 62;

							Row.row62 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 63;

							Row.row63 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 64;

							Row.row64 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 65;

							Row.row65 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 66;

							Row.row66 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 67;

							Row.row67 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 68;

							Row.row68 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 69;

							Row.row69 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 70;

							Row.row70 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 71;

							Row.row71 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 72;

							Row.row72 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 73;

							Row.row73 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 74;

							Row.row74 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 75;

							Row.row75 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 76;

							Row.row76 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 77;

							Row.row77 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 78;

							Row.row78 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 79;

							Row.row79 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 80;

							Row.row80 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 81;

							Row.row81 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 82;

							Row.row82 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 83;

							Row.row83 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 84;

							Row.row84 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 85;

							Row.row85 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 86;

							Row.row86 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 87;

							Row.row87 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 88;

							Row.row88 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 89;

							Row.row89 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 90;

							Row.row90 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 91;

							Row.row91 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 92;

							Row.row92 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);

							columnIndexWithD_tFileInputDelimited = 93;

							Row.row93 = fid_tFileInputDelimited.get(columnIndexWithD_tFileInputDelimited);
...
// Start of branch "Row"
						if (Row != null) {
							...
							String[] rowtFileOutputDelimited = new String[94];
					...
					if (!((Object) ("G:/.shortcut-targets-by-id/13dwvsJwtH7qTkK0HGZd6OyiOZv0nXuVy/01. Proyecto WV/07. Migración/08. PRX/FACTIVOS.csv") instanceof java.io.InputStream)) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"migracion_cajamar/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 106497 characters generated by Talend Open Studio for Data Integration on the
 * October 18, 2023 at 6:33:33 PM CEST
 ************************************************************************************************/